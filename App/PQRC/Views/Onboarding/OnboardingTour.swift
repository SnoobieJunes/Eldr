...
enum EnterpriseTourScript {
    static let steps: [TourStep] = [
        TourStep(
            ...
            fieldNote:
                "Named for Óðinn's raven Huginn — \u{201C}thought.\u{201D} Send it out by pairing a phone from the Bridge (phone tether) tab; the team integrations are rolling out now.",
            voiceOver:
